...
def test_displayBorrowed(setup):
    lcd, keypad = setup

    borrowList = {
        'Test1&1234567': [['Book 1', '2024-06-15 21:30:29'], 
    ...
    displayBorrowed(borrowList, person, books)
    
    expected_commands = [
        "LCD cleared",
        "LCD Line 1: Introduction to Python press 1",
        "LCD Line 2: Data Science with Python press 2",
        "LCD cleared",
        "LCD Line 1: Advanced Python press 3",
        "LCD Line 2: Machine Learning with Python press 4",
        "LCD cleared",
        "LCD Line 1: Deep Learning with Python press 5"
    ]

    assert lcd.commands == expected_commands

def test_returnBook(setup):
    lcd, keypad = setup
    ...
    returnIndex = ['1', '2', '3', '4', '*']
    returned_books = returnBook(returnIndex, borrowList, person)
    
    expected_returned_books = {
        'Test1&1234567': [['Book 1'], ['Book 3'], ['Book 2'], ['Book 9']]
    }

    assert returned_books == expected_returned_books
